...
export default function Footer({ onOpenChat }) {
  return (
    <footer className="bg-white text-slate-800 border-t border-slate-200 py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row gap-12 justify-between">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-10 text-sm">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              onClick={onOpenChat}
              className="text-left font-extrabold text-rose-600 hover:text-rose-700 mt-1 flex items-center gap-1"
            >
              <span>Start Free Chat</span>
              <span className="material-symbols-outlined text-xs">arrow_forward</span>
            </button>

            <div className="flex items-center gap-2.5 p-2 border border-slate-200 rounded-xl w-fit bg-slate-50 mt-3">
              <a
